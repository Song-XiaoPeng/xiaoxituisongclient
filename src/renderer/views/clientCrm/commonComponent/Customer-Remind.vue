       ...
       <div class="list">
           <div v-for="(k, i) in remindListArr">
               ...
               <div class="txt">
                   ...
                   <div class="fulfill">
                       <div class="left">
                           <span v-if="k.is_complete == 1">{{k.complete_content}}</span>
                       ...
                       <div class="right">
                           <div class="icon-btn-box">
                               ...
                               <div class="btn">
                                   <span  class="" v-if="k.is_complete == -1"  style="color: #efbc6c;" @click="popup1 = true, RemindData = k,RemindDate = k.remind_time, txta = k.remind_content">修改</span>
